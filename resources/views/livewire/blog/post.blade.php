            ...
            <div class="container services__container">
                ...
                <div class="row services__row">
                    ...
                    <div class="col-md-4">
                        ...
                        </a><div class="services__card"><a class="card__img">
                                <img class="img-fluid" src="./img/services/services-card-1.jpg" alt="">
                            </a><a href="#" class="card__info">
                    ...
                    <div class="col-md-4">
                        <a class="card__img" href="#">
                        </a><div class="services__card"><a class="card__img" href="#">
                                <img class="img-fluid" src="./img/services/services-card-2.jpg" alt="">
                            </a><a href="#" class="card__info">
                                <div class="card__title">
                                    <h5>
                                        Дитячі<br>канали
                    ...
                    <div class="col-md-4">
                        <a class="card__img" href="#">
                                ...
                                <img class="img-fluid" src="./img/services/services-card-3.jpg" alt="">
                            </a><a href="#" class="card__info">
                                <div class="card__title">
                                    <h5>
                                        Обтурація
