<div>
    <section class="services services__free" id="services__free">
        ...
        <div class="container services__container">
            ...
            <div class="row services__row">
                @foreach($webinars as $webinar)
                    <div class="col-md-4">
                        <a class="card__img" href="{{route('free-webinar')}}">
                            <div class="services__card">
                                <img class="img-fluid" src="{{asset('storage/' . $webinar->image)}}"
                                     alt="">
                                <a href="{{route('free-webinar')}}" class="card__info">
            ...
            <a href="{{route('free-webinar')}}" class="section__link-secondary">
                Більше безкоштовних вебінарів
            </a>
