        ...
        <section class="services-opened" style="margin-top: 0;">
            ...
            <div class="container free-webinars__container">
                ...
                <div class="row free-webinars__row">
                    ...
                    @foreach($freeWebinars as $webinar)
                        <div class="col-md-6">
                            <a class="card__img" href="#">
                                <div class="services__card free-webinars__card" data-video-url="{{$webinar->link}}">
                                    ...
                                    <iframe class="video-frame" width="1280" height="720"
                                            title="Поширені ураження слизової оболонки." frameborder="0"
                                    ...
                                    <div class="services-opened__card-play">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90"
                                            ...
                                            <path d="M60.905 41.4922C62.985 43.0934 62.985 46.2302 60.905 47.8314L40.4292 63.5937C37.7989 65.6185 33.9892 63.7434 33.9892 60.4241V28.8995C33.9892 25.5801 37.7989 23.7051 40.4292 25.7299L60.905 41.4922Z"
                                                  fill="white" fill-opacity="0.86"/>
                                            <defs>
                                                <filter id="filter0_b_0_1352" x="-13" y="-13" width="115.323"
                                                        height="115.323" filterUnits="userSpaceOnUse"
                                                        color-interpolation-filters="sRGB">
                                                    <feFlood flood-opacity="0" result="BackgroundImageFix"/>
                                                    <feGaussianBlur in="BackgroundImageFix" stdDeviation="6.5"/>
                                                    <feComposite in2="SourceAlpha" operator="in"
                                                                 result="effect1_backgroundBlur_0_1352"/>
                                                    <feBlend mode="normal" in="SourceGraphic"
                                                             in2="effect1_backgroundBlur_0_1352" result="shape"/>
                                                </filter>
                                            </defs>
                                        </svg>
                                    </div>
