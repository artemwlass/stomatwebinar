                    ...
                    <div class="tab-body active">
                            ...
                            <div class="content">
                                <div class="content-item">
                                    <div class="content-item__left">
                                        <p>Гнатологія XXl століття: диагностіка та менеджмент дисфункцій СНЩС 2025-2169-1014302-94761. pdf</p>
                                        <ul>
                                            <li class="bg-blue">100 баллів</li>
                                            <li>Лектор: Андрей Андреевич</li>
                                        </ul>
                                    </div>
                                    <a href="#" class="content-item__right">
                        ...
                        <div class="tab-body__item">
                            <h3>
                                ...
                                <span>Серпень 2025</span>
                            </h3>
                            <div class="content">
                                <div class="content-item">
                                    <div class="content-item__left">
                                        <p>Місцева анестезія в стоматологіі: від А до Я 2025-2009-94557575-46565.pdf</p>
                                        <ul>
                                            <li class="bg-blue">100 баллів</li>
                                            <li>Лектор: Андрей Андреевич</li>
                                        </ul>
